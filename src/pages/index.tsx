  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless operations with CMS App - your ultimate solution for efficient and streamlined coolant management."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless operations with CMS App - your ultimate solution for efficient and streamlined coolant management.`}
            </Text>
            <Box
